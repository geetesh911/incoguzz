...
@TypeGraphQL.InputType("UserCreateWithoutReceivedFollowRequestsInput", {
  isAbstract: true,
})
export class UserCreateWithoutReceivedFollowRequestsInput {
  ...
  @TypeGraphQL.Field(_type => ActivityCreateNestedManyWithoutUserInput, {
    nullable: true,
  })
  activities?: ActivityCreateNestedManyWithoutUserInput | undefined;
