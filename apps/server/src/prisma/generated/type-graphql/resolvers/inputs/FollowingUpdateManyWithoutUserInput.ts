...
@TypeGraphQL.InputType("FollowingUpdateManyWithoutUserInput", {
  isAbstract: true,
})
export class FollowingUpdateManyWithoutUserInput {
  ...
  @TypeGraphQL.Field(
    _type => [FollowingUpsertWithWhereUniqueWithoutUserInput],
    {
      nullable: true,
    },
  )
  ...
  @TypeGraphQL.Field(
    _type => [FollowingUpdateWithWhereUniqueWithoutUserInput],
    {
      nullable: true,
    },
  )
