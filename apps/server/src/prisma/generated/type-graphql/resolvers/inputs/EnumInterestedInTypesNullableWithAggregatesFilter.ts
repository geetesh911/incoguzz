...
import { NestedEnumInterestedInTypesNullableWithAggregatesFilter } from "../inputs/NestedEnumInterestedInTypesNullableWithAggregatesFilter";
import { NestedIntNullableFilter } from "../inputs/NestedIntNullableFilter";
import { InterestedInTypes } from "../../enums/InterestedInTypes";

@TypeGraphQL.InputType("EnumInterestedInTypesNullableWithAggregatesFilter", {
  isAbstract: true,
})
export class EnumInterestedInTypesNullableWithAggregatesFilter {
