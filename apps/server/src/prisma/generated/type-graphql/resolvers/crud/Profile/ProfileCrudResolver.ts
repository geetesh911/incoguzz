...
export class ProfileCrudResolver {
  ...
  async profile(
    ...
    @TypeGraphQL.Args() args: FindUniqueProfileArgs,
  ...
  async findFirstProfile(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstProfileArgs,
  ): Promise<Profile | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async profiles(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindManyProfileArgs,
  ): Promise<Profile[]> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createProfile(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateProfileArgs,
  ): Promise<Profile> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createManyProfile(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyProfileArgs,
  ...
  async deleteProfile(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteProfileArgs,
  ): Promise<Profile | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async updateProfile(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateProfileArgs,
  ): Promise<Profile | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async deleteManyProfile(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteManyProfileArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async updateManyProfile(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateManyProfileArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async upsertProfile(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertProfileArgs,
  ): Promise<Profile> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async aggregateProfile(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: AggregateProfileArgs,
