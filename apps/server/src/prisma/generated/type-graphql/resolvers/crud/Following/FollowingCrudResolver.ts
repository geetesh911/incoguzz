...
export class FollowingCrudResolver {
  ...
  async following(
    ...
    @TypeGraphQL.Args() args: FindUniqueFollowingArgs,
  ...
  async findFirstFollowing(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstFollowingArgs,
  ): Promise<Following | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async followings(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindManyFollowingArgs,
  ): Promise<Following[]> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createFollowing(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateFollowingArgs,
  ): Promise<Following> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createManyFollowing(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyFollowingArgs,
  ...
  async deleteFollowing(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteFollowingArgs,
  ): Promise<Following | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async updateFollowing(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateFollowingArgs,
  ): Promise<Following | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async deleteManyFollowing(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteManyFollowingArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async updateManyFollowing(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateManyFollowingArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async upsertFollowing(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertFollowingArgs,
  ): Promise<Following> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async aggregateFollowing(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: AggregateFollowingArgs,
  ): Promise<AggregateFollowing> {
  ...
  async groupByFollowing(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: GroupByFollowingArgs,
  ): Promise<FollowingGroupBy[]> {
