...
export class FollowerCrudResolver {
  ...
  async follower(
    ...
    @TypeGraphQL.Args() args: FindUniqueFollowerArgs,
  ...
  async findFirstFollower(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindFirstFollowerArgs,
  ): Promise<Follower | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async followers(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: FindManyFollowerArgs,
  ): Promise<Follower[]> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createFollower(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateFollowerArgs,
  ): Promise<Follower> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async createManyFollower(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: CreateManyFollowerArgs,
  ...
  async deleteFollower(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteFollowerArgs,
  ): Promise<Follower | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async updateFollower(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateFollowerArgs,
  ): Promise<Follower | null> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async deleteManyFollower(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: DeleteManyFollowerArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async updateManyFollower(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpdateManyFollowerArgs,
  ): Promise<AffectedRowsOutput> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async upsertFollower(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: UpsertFollowerArgs,
  ): Promise<Follower> {
    const { _count } = transformFields(graphqlFields(info as any));
  ...
  async aggregateFollower(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: AggregateFollowerArgs,
  ): Promise<AggregateFollower> {
  ...
  async groupByFollower(
    @TypeGraphQL.Ctx() ctx: any,
    @TypeGraphQL.Info() info: GraphQLResolveInfo,
    @TypeGraphQL.Args() args: GroupByFollowerArgs,
  ): Promise<FollowerGroupBy[]> {
