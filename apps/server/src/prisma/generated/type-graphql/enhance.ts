...
const actionResolversMap = {
  ...
  Bookmark: {
    ...
    createBookmark: actionResolvers.CreateBookmarkResolver,
    createManyBookmark: actionResolvers.CreateManyBookmarkResolver,
    deleteBookmark: actionResolvers.DeleteBookmarkResolver,
    updateBookmark: actionResolvers.UpdateBookmarkResolver,
    ...
    upsertBookmark: actionResolvers.UpsertBookmarkResolver,
...
const argsInfo = {
  ...
  CreateBookmarkArgs: ["data"],
  CreateManyBookmarkArgs: ["data", "skipDuplicates"],
  DeleteBookmarkArgs: ["where"],
  UpdateBookmarkArgs: ["data", "where"],
  DeleteManyBookmarkArgs: ["where"],
  UpdateManyBookmarkArgs: ["data", "where"],
  UpsertBookmarkArgs: ["where", "create", "update"],
...
const modelsInfo = {
  ...
  Audio: ["id", "url", "postId", "thumbnailUrl"],
  Tag: ["id", "name"],
  Place: ["id", "name", "address"],
  Bookmark: ["id", "postId", "userId", "createdAt", "updatedAt"],
  Reaction: ["id", "postId", "userId", "reaction", "createdAt", "updatedAt"],
  Comment: ["id", "comment", "postId", "userId", "createdAt", "updatedAt"],
  CommentReplies: [
    "id",
    "comment",
    "repliedToId",
...
const outputsInfo = {
  ...
  AudioCountAggregate: ["id", "url", "postId", "thumbnailUrl", "_all"],
  AudioMinAggregate: ["id", "url", "postId", "thumbnailUrl"],
  AudioMaxAggregate: ["id", "url", "postId", "thumbnailUrl"],
  TagCount: ["posts"],
  ...
  BookmarkMinAggregate: ["id", "postId", "userId", "createdAt", "updatedAt"],
  BookmarkMaxAggregate: ["id", "postId", "userId", "createdAt", "updatedAt"],
...
const inputsInfo = {
  ...
  ClipCreateInput: ["id", "url", "post", "thumbnailUrl", "clipAudio"],
  ClipUpdateInput: ["id", "url", "post", "thumbnailUrl", "clipAudio"],
  ...
  AudioCreateInput: ["id", "url", "post", "thumbnailUrl"],
  AudioUpdateInput: ["id", "url", "post", "thumbnailUrl"],
  AudioCreateManyInput: ["id", "url", "postId", "thumbnailUrl"],
  AudioUpdateManyMutationInput: ["id", "url", "thumbnailUrl"],
  ...
  BookmarkCreateInput: ["id", "post", "user", "createdAt", "updatedAt"],
  BookmarkUpdateInput: ["id", "post", "user", "createdAt", "updatedAt"],
  BookmarkCreateManyInput: ["id", "postId", "userId", "createdAt", "updatedAt"],
  BookmarkUpdateManyMutationInput: ["id", "createdAt", "updatedAt"],
  ReactionCreateInput: [
    "id",
    "post",
    "user",
  ...
  ReactionUpdateManyMutationInput: ["id", "reaction", "createdAt", "updatedAt"],
  CommentCreateInput: [
    "id",
    "comment",
    "post",
  ...
  CommentUpdateManyMutationInput: ["id", "comment", "createdAt", "updatedAt"],
  CommentRepliesCreateInput: [
    "id",
    "comment",
    "repliedTo",
    "user",
  ...
  CommentRepliesUpdateManyMutationInput: [
    "id",
    "comment",
    "createdAt",
    "updatedAt",
  ],
  FollowerCreateInput: ["id", "user", "createdAt", "updatedAt"],
  FollowerUpdateInput: ["id", "user", "createdAt", "updatedAt"],
  FollowerCreateManyInput: ["id", "userId", "createdAt", "updatedAt"],
  FollowerUpdateManyMutationInput: ["id", "createdAt", "updatedAt"],
  FollowingCreateInput: ["id", "user", "createdAt", "updatedAt"],
  FollowingUpdateInput: ["id", "user", "createdAt", "updatedAt"],
  ...
  ActivityCreateInput: ["id", "type", "user", "post", "createdAt", "updatedAt"],
  ActivityUpdateInput: ["id", "type", "user", "post", "createdAt", "updatedAt"],
  ...
  PostSumOrderByAggregateInput: ["views"],
  ...
  EnumReactionTypeWithAggregatesFilter: [
    "equals",
    "in",
    "notIn",
    "not",
  ...
  BookmarkUpdateManyWithoutUserInput: [
    "create",
    "connectOrCreate",
    "upsert",
    "createMany",
  ...
  BookmarkUpdateManyWithoutPostInput: [
    "create",
    "connectOrCreate",
    "upsert",
    "createMany",
  ...
  PostUpdateOneRequiredWithoutBookmarksInput: [
    "create",
    "connectOrCreate",
    "upsert",
    "connect",
  ...
  UserUpdateOneRequiredWithoutBookmarksInput: [
    "create",
    "connectOrCreate",
    "upsert",
    "connect",
  ...
  PostUpdateOneRequiredWithoutReactionsInput: [
    "create",
    "connectOrCreate",
    "upsert",
    "connect",
  ...
  ReactionCreateOrConnectWithoutUserInput: ["where", "create"],
  ReactionCreateManyUserInputEnvelope: ["data", "skipDuplicates"],
  BookmarkCreateWithoutUserInput: ["id", "post", "createdAt", "updatedAt"],
  ...
  CommentRepliesCreateWithoutUserInput: [
    "id",
    "comment",
    "repliedTo",
    "createdAt",
  ...
  ReactionUpdateManyWithWhereWithoutUserInput: ["where", "data"],
  ...
  AudioCreateWithoutPostInput: ["id", "url", "thumbnailUrl"],
  ...
  BookmarkCreateWithoutPostInput: ["id", "user", "createdAt", "updatedAt"],
  ...
  AudioUpdateWithoutPostInput: ["id", "url", "thumbnailUrl"],
  ...
  PostUpsertWithoutBookmarksInput: ["update", "create"],
  ...
  CommentRepliesCreateWithoutRepliedToInput: [
    "id",
    "comment",
    "user",
    "createdAt",
  ...
  CommentCreateWithoutCommentRepliesInput: [
    "id",
    "comment",
    "post",
    "user",
  ...
  CommentUpdateWithoutCommentRepliesInput: [
    "id",
    "comment",
    "post",
    "user",
  ...
  BookmarkCreateManyUserInput: ["id", "postId", "createdAt", "updatedAt"],
  ...
  CommentRepliesCreateManyUserInput: [
    "id",
    "comment",
    "repliedToId",
    "createdAt",
  ...
  BookmarkUpdateWithoutUserInput: ["id", "post", "createdAt", "updatedAt"],
  ...
  CommentRepliesUpdateWithoutUserInput: [
    "id",
    "comment",
    "repliedTo",
    "createdAt",
  ...
  BookmarkCreateManyPostInput: ["id", "userId", "createdAt", "updatedAt"],
  ...
  BookmarkUpdateWithoutPostInput: ["id", "user", "createdAt", "updatedAt"],
  ...
  ClipUpdateWithoutClipAudioInput: ["id", "url", "post", "thumbnailUrl"],
  ...
  CommentRepliesUpdateWithoutRepliedToInput: [
    "id",
    "comment",
    "user",
    "createdAt",
