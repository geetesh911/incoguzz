...
import { StyledWheelPickerItemContainer } from "./styled";
...
export interface WheelPickerProps extends FlatListProps<any> {
...
export class WheelPicker extends Component<WheelPickerProps, State> {
    ...
    return (
      <StyledWheelPickerItemContainer
        ...
        style={{
          marginLeft: marginStart({
            horizontal,
            index,
            size: this.widthParent,
            offset: offsetSelection,
            manualMargin: startMargin,
          }),
          marginRight: marginEnd({
            ...
            size: this.widthParent,
            offset: offsetSelection,
            manualMargin: endMargin,
          }),
          marginTop: marginStart({
            horizontal: !horizontal,
            index,
            size: this.heightParent,
            offset: offsetSelection,
            manualMargin: startMargin,
          }),
      ...
      >
        ...
        {renderItem && selectOnPress && (
          <Pressable onPress={handlePressOnItem}>{renderItem(info)}</Pressable>
        )}
      </StyledWheelPickerItemContainer>
    );
  };
      ...
      <FlatList
        ...
        getItemLayout={(_, index) => {
          ...
          if (snapInterval) {
            ...
            const horizontalLength = horizontal
              ? this.options[index].layout.width
              : this.options[index].layout.height;
            ...
            itemLayout = {
              length: this.options[index] ? horizontalLength : 30,
              offset: this.options[index] ? horizontalOffset : 30 * index,
              index,
            };
          }
          return itemLayout;
