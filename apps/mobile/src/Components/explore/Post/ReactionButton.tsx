...
export default class ReactionButton extends Component {
  soundBoxDown: Sound;
  soundBoxUp: Sound;
  soundIconChoose: Sound;
  soundIconFocus: Sound;
  soundShortTouchLike: Sound;
  ...
  rootPanResponder?: PanResponderInstance;
  timerMeasureLongTouch?: NodeJS.Timeout | number;
  ...
  constructor(props: any) {
    ...
    // Like
    this.pushIconLikeUp = new Animated.Value(25);
    ...
    // Love
    this.pushIconLoveUp = new Animated.Value(25);
    this.zoomIconLove = new Animated.Value(0.01);
    // Haha
    this.pushIconHahaUp = new Animated.Value(25);
    this.zoomIconHaha = new Animated.Value(0.01);
    // Wow
    this.pushIconWowUp = new Animated.Value(25);
    this.zoomIconWow = new Animated.Value(0.01);
    // Sad
    this.pushIconSadUp = new Animated.Value(25);
    this.zoomIconSad = new Animated.Value(0.01);
    // Angry
    this.pushIconAngryUp = new Animated.Value(25);
    ...
    this.pushTextDescriptionUp = new Animated.Value(100);
  ...
  onTouchEnd = () => {
    ...
    if (!this.isLongTouch) {
      ...
      clearTimeout(this.timerMeasureLongTouch as number);
  ...
  // ------------------------------------------------------------------------------
  // Animation for zoom emoticons when drag
  handleWhenDragBetweenIcon = (currentIcon: number) => {
  ...
  controlIconWhenDrag = () => {
    ...
    this.pushTextDescriptionUp.setValue(100);
  ...
  getIconBtn() {
    if (!this.isLongTouch && this.isLiked) {
      return "https://raw.githubusercontent.com/duytq94/facebook-reaction-animation2/master/Images/like.gif";
    } else if (!this.isDragging) {
      switch (this.whichIconUserChoose) {
        case 1:
          return "https://raw.githubusercontent.com/duytq94/facebook-reaction-animation2/master/Images/like.gif";
        case 2:
          return "https://raw.githubusercontent.com/duytq94/facebook-reaction-animation2/master/Images/love.gif";
        case 3:
          return "https://raw.githubusercontent.com/duytq94/facebook-reaction-animation2/master/Images/haha.gif";
        case 4:
          return "https://raw.githubusercontent.com/duytq94/facebook-reaction-animation2/master/Images/wow.gif";
        case 5:
          return "https://raw.githubusercontent.com/duytq94/facebook-reaction-animation2/master/Images/sad.gif";
        case 6:
          return "https://raw.githubusercontent.com/duytq94/facebook-reaction-animation2/master/Images/angry.gif";
        default:
          return "https://raw.githubusercontent.com/duytq94/facebook-reaction-animation2/master/Images/like.gif";
      }
    } else {
