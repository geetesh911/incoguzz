...
export const FireEmoji: FC<IIconInterface> = ({ height, width }) => {
  return (
    <Svg
      width={width || 720}
      height={height || 720}
    ...
    >
      ...
      />
      <Path
        d="M270.19 111.301c-14.4 14.23 5.421 73.016-39.643 96.226 0 0-15.247-64.546 39.643-96.226Z"
        fill="url(#c)"
      />
      <Path
        opacity={0.5}
      ...
      />
      <Path
        d="M270.19 111.301c-14.231 14.23-5.083 59.125-39.643 96.226 0 0-15.247-64.546 39.643-96.226Z"
        fill="url(#m)"
      />
      <Path
        opacity={0.5}
      ...
      <Defs>
        ...
        <RadialGradient
          ...
          r={1}
          gradientUnits="userSpaceOnUse"
          gradientTransform="matrix(-6.41071 72.4403 -29.14779 -2.57948 255.52 106.935)"
        >
          <Stop offset={0.001} stopColor="#FFED1C" />
          <Stop offset={0.2} stopColor="#FFEE2B" stopOpacity={0.801} />
          <Stop offset={0.584} stopColor="#FFF254" stopOpacity={0.417} />
