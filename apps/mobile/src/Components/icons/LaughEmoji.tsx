...
export const LaughEmoji: FC<IIconInterface> = ({ height, width }) => {
  return (
    <Svg
      width={width || 720}
      height={height || 720}
    ...
    >
      ...
      />
      <Path
        d="M170.172 540.518c15.412 34.576-7.773 67.41-36.319 73.977-28.545 6.432-60.843-11.526-64.327-47.442-8.175-82.018 84.966-136.026 84.966-136.026s-5.093 62.853 15.68 109.491Z"
        fill="url(#d)"
      />
      <Path
      ...
      />
      <Path
        d="M151.542 521.219c13.401 60.576-54.41 87.647-80.678 54.009 7.371 30.287 36.587 45.029 62.854 39.132 28.545-6.432 51.73-39.4 36.318-73.976-20.638-46.504-15.546-109.357-15.546-109.357s-13.937 40.473-2.948 90.192Z"
        fill="url(#f)"
      />
      <Path
      ...
      />
      <Path
        d="M575.702 372.463c13.535 35.381 53.204 42.215 77.997 26.535 24.793-15.679 34.844-51.193 11.927-79.069-52.266-63.657-156.262-36.05-156.262-36.05s48.111 41.009 66.338 88.584Z"
        fill="url(#j)"
      />
      <Path
        d="M608.268 351.154c32.432 18.36 72.77-16.082 43.823-44.896a102.523 102.523 0 0 1 13.67 13.804c22.916 27.875 12.865 63.39-11.928 79.069-24.793 15.68-64.461 8.845-77.997-26.535-18.226-47.575-66.338-88.584-66.338-88.584 75.317 31.225 82.822 58.163 98.77 67.142Z"
        fill="url(#k)"
      />
      <Path
        d="M575.3 345.794c33.37 52.266 100.512 23.453 95.285-18.896 16.216 26.669 5.897 57.76-16.752 72.1-24.793 15.68-64.462 8.845-77.997-26.535-18.226-47.576-66.338-88.585-66.338-88.585s38.463 18.897 65.802 61.916Z"
        fill="url(#l)"
      />
      <Path
        d="M598.35 374.606c39.267 26.268 75.853-8.443 76.255-39.936 5.093 12.329 5.093 25.195 1.072 36.72-29.349 50.792-88.048 26.669-99.037 3.082l-.804-2.01c-.268-.804-.67-1.742-1.072-2.68-19.031-46.37-65.266-85.77-65.266-85.77 59.637 38.194 40.741 58.431 88.852 90.594Z"
        fill="url(#m)"
      />
      <Path
        opacity={0.75}
      ...
      />
      <Path
        d="M176.335 476.863c-.402 0-.804.134-1.206.402-3.618 1.876-20.37 13.267 13.268 50.122v.134c15.144 14.875 37.658 33.236 66.606 46.637-27.876-14.474-9.917-36.184 33.102-48.246 43.019-12.061 99.037-35.112 99.037-35.112l-25.597-61.781c-59.503 24.659-121.82 40.741-185.21 47.844Z"
        fill="url(#o)"
      />
      <Path
        d="M526.385 331.857c.402-.268.67-.536 1.072-.67 3.886-1.206 23.854-4.959 26.133 44.895h.134c-.268 21.309-3.217 50.122-14.072 80.142 9.515-29.886-18.628-32.566-57.493-10.722-38.998 21.845-94.883 45.298-94.883 45.298l-25.597-61.782c59.369-24.658 114.852-57.358 164.706-97.161Z"
        fill="url(#p)"
      />
      <Path
        d="M533.352 396.718c6.969-4.959 9.917-13.938 7.371-22.113l-8.979-29.617c-49.988 39.534-105.471 71.966-164.974 96.625-59.369 24.659-121.552 40.875-184.941 48.38l14.607 27.339c4.021 7.505 12.464 11.794 20.907 10.453 56.554-9.113 112.171-24.927 165.643-47.039 53.473-22.247 103.863-50.39 150.366-84.028Z"
        fill="url(#q)"
      />
      <Path
        d="M460.584 191.545c-2.144-2.815-5.629-3.485-8.577-1.609-15.546 9.381-39.803 32.03-61.513 57.493-17.288 20.236-31.226 60.843-24.391 70.492 7.639 10.722 44.761 7.639 60.307 5.763 24.391-2.814 55.482-9.515 69.554-19.432 3.752-2.681 4.02-6.031 3.082-8.309-1.34-3.217-5.092-4.825-9.515-4.155-48.916 7.237-83.492 6.701-86.44-.134 0 0-6.165-10.051 15.948-38.998 13.402-17.69 29.081-34.308 38.864-44.226 5.495-6.566 5.629-12.865 2.681-16.885Z"
        fill="url(#r)"
      />
      <Path
      ...
      />
      <Path
        d="M499.045 295.938c-1.34-3.216-5.092-4.824-9.515-4.154-48.916 7.237-83.492 6.701-86.44-.134 4.958 11.525 7.639 17.154 48.514 12.061 30.287-3.752 44.493-6.03 44.359.536 3.618-2.68 4.02-6.03 3.082-8.309Z"
        fill="url(#t)"
      />
      <Path
      ...
      <Defs>
        ...
        <RadialGradient
          ...
          r={1}
          gradientUnits="userSpaceOnUse"
          gradientTransform="rotate(-22.5 1313.597 -705.242) scale(348.011)"
        >
