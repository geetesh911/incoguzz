...
export const HeartDimEmoji: FC<IIconInterface> = ({ height, width }) => {
  return (
    <Svg
      width={width || 720}
      height={height || 720}
    ...
    >
      <G opacity={0.5}>
        ...
        <Path
          opacity={0.5}
          d="M555.329 113.037c86.373 137.657 6.838 318.321-88.713 369.605-105.447 56.682-177.604 30.05-326.958-54.703C224.772 540.763 359.91 621.918 359.91 621.918s287.91-172.926 287.91-365.286c0-63.7-37.968-118.763-92.491-143.595Z"
          fill="url(#b)"
        />
        <Path
          opacity={0.5}
        ...
        <Path
          opacity={0.24}
          d="M513.402 132.828c22.493 24.832 8.637 73.957-30.771 109.586-39.408 35.629-89.612 44.446-112.105 19.614-22.493-24.832-8.637-73.957 30.771-109.586 39.407-35.629 89.612-44.446 112.105-19.614Z"
          fill="url(#f)"
        />
        <Path
          opacity={0.32}
