...
export const PopperEmoji: FC<IIconInterface> = ({ height, width }) => {
  return (
    <Svg
      width={width || 720}
      height={height || 720}
    ...
    >
      ...
      />
      <Path
        d="M510.059 476.322c-17.801 17.8-89.638-25.429-160.68-96.313-70.884-70.883-114.113-142.879-96.313-160.68 17.8-17.8 89.638 25.429 160.68 96.313 70.884 71.042 113.954 142.879 96.313 160.68Z"
        fill="url(#j)"
      />
      <Path
      ...
      />
      <Path
        d="M413.586 99.497s-8.264 17.641-9.377 19.549c-4.132 6.993-15.734 9.377-36.554 6.516-20.82-2.861-26.859-1.748-27.813-1.589-.953.317-13.191-9.536-13.191-9.536l1.112-10.013s2.861-3.814 12.397-2.543c17.006 2.543 67.069 10.966 73.426-2.384Z"
        fill="url(#l)"
      />
      <Path
      ...
      />
      <Path
        d="M273.886 163.228c23.045 13.668 2.543 32.422 15.575 43.071l17.959-16.052c-13.032-10.649 5.722-29.085-17.323-42.753l-16.211 15.734Z"
        fill="url(#n)"
      />
      <Path
      ...
      />
      <Path
        d="M521.342 299.275s-.953 10.331-5.721 15.099c-8.582 8.423-22.251-4.291-39.574.318 0 0 7.946-20.185 8.741-21.774 0 0 6.993-4.291 14.145-.159 7.311 3.973 13.668 5.245 18.118 2.861 4.45-2.384 4.291 3.655 4.291 3.655Z"
        fill="url(#p)"
      />
      <Path
        d="M567.91 253.819s-17.005 7.788-19.23 8.9c-2.226 1.113-7.311-38.461 4.926-42.435 12.397-3.973 20.82-5.403 22.092-5.562 1.271-.318-21.297 2.066-7.788 39.097ZM515.621 314.211c6.993-7.31 16.528-18.118 16.052-21.137-2.225-19.39-17.96-62.143-3.497-69.93 0 0-13.509 9.535-17.641 12.396-4.132 2.861-7.152 10.49-6.834 23.045.794 21.933 18.277 49.11 11.92 55.626Z"
        fill="#FFBF00"
      />
      <Path
        d="M467.306 157.346c-11.602 81.532-92.498 159.408-92.498 159.408l10.966 16.688s88.048-91.704 99.332-173.553l-17.8-2.543Z"
        fill="url(#q)"
      />
      <Path
        d="M318.068 123.335c-1.907 3.496 3.656 9.377 17.006 25.588s47.997 59.123 38.144 74.698l10.648-21.933s.159-17.482-10.331-34.488c-16.529-26.7-48.156-55.467-45.772-62.619l-9.695 18.754Z"
        fill="url(#r)"
      />
      <Path
        d="M388.952 371.427a6.516 6.516 0 1 0 0-13.032 6.516 6.516 0 1 0 0 13.032Z"
        fill="url(#s)"
      />
      <Path
      ...
      />
      <Path
        d="M462.855 453.911c66.434-54.514 178.957-65.798 178.957-65.798l3.656-25.111s-133.185 15.893-203.751 77.082c7.629 5.245 14.622 9.854 21.138 13.827Z"
        fill="url(#B)"
      />
      <Path
        d="M296.137 296.89c4.45 6.039 9.377 12.079 14.622 18.436 14.145-31.151 11.125-55.626 11.125-55.626l-17.323-10.807c1.748 19.23-4.133 37.666-8.424 47.997Z"
        fill="url(#C)"
      />
      <Defs>
        <LinearGradient
